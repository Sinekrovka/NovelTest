        ...
        public void SaveGraph(StoryObject _story, ExtendedGraphView _graph)
        {
            ...
            foreach (BaseNode _node in _graph.nodes.ToList().Cast<BaseNode>().ToList())
            {
                    ...
                    new NodeData
                    {
                        ...
                        characterPositionOnScreen = _node.nodeData.characterPositionOnScreen,
                        characterFade = _node.nodeData.characterFade,
                        characterMovement = _node.nodeData.characterMovement,
                        characterColor = _node.nodeData.characterColor,
                        backgroundfade = _node.nodeData.backgroundfade,
                        backgroundColor = _node.nodeData.backgroundColor,
                    });
            }
